...
# Mock structlog before importing security module
mock_logger = MagicMock()
with patch.dict('sys.modules', {'structlog': MagicMock(), 'app.core.logger': MagicMock()}):
    with patch('structlog.get_logger', return_value=mock_logger):
        ...
        t = TestSecurityHelpers()
        t.test_password_hash_roundtrip()
        t.test_jwt_payload_structure()
        t.test_jwt_expiry()
