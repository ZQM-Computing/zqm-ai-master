"""
The Void AI Orchestration System — Agent Models
Version: 2.0.0 | ZQM Computing LLC

Schemas for the The Void autonomous agent pool.
"""
...
class AgentPerformanceMetrics(BaseModel):
    ...
    def update_calibration(self, confidence: Optional[float], verified: bool) -> Optional[float]:
        ...
        if confidence is None or not verified:
            return None
        accuracy = 1.0 if verified else 0.0
        return abs(confidence - accuracy)


class Agent(BaseModel):
    """An autonomous The Void agent instance."""
