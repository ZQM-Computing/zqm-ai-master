"""
The Void AI Orchestration System — /api/settings Router
...
async def get_settings_view(
    ...
    safe_settings = {
        ...
        "zqm_ai_employee_id": settings.zqm_ai_employee_id,
        "zqm_ai_primary_garden": settings.zqm_ai_primary_garden,
        "port": settings.port,
        "default_ai_provider": settings.default_ai_provider,
        "max_concurrent_tasks": settings.max_concurrent_tasks,
        "task_timeout_seconds": settings.task_timeout_seconds,
        "void_cache_max_size": settings.void_cache_max_size,
        "void_cache_strategy": settings.void_cache_strategy,
        "cache_ttl_seconds": settings.cache_ttl_seconds,
        "garden_endpoint": settings.garden_endpoint,
        "garden_nodes": settings.garden_nodes,
        "garden_timeout": settings.garden_timeout,
        "flatspace_endpoint": settings.flatspace_endpoint,
    ...
    return ZQM_AIResponse.ok(data=safe_settings, message="Current settings")
...
async def update_settings(
    ...
    if update.void_cache_strategy is not None:
        orchestrator.cache._strategy = update.void_cache_strategy.upper()
        _runtime_overrides["void_cache_strategy"] = update.void_cache_strategy
        changes["void_cache_strategy"] = update.void_cache_strategy
